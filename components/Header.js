    ...
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      <div className="ml-4  md:flex-grow  flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
        <input
          ...
          className="flex-grow ml-4   bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400"
          type="text"
      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 max-auto mt-5                        ">
          <DateRangePicker
          ...
          <div className="flex justify-around	">
            <button
              onClick={resetInput}
              className="flex text-white bg-red-600 hover:bg-red-700 rounded-full py-2 px-4 "
            >
              Cancel
            </button>
            <button
              onClick={search}
              className="flex text-white bg-blue-500 hover:bg-blue-700 py-2 px-4 rounded-full"
            >
              Search
            </button>
          </div>
